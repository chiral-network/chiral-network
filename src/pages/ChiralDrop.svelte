...
<div class="p-4 sm:p-6 h-[calc(100vh-64px)] flex flex-col gap-4 sm:gap-6">
 ...
 class="inline-flex items-center gap-2 rounded-xl border border-[var(--border)]/60 bg-[var(--surface-0)] px-4 py-2 text-sm font-medium text-[var(--text-secondary)] transition hover:bg-[var(--surface-0)] focus:outline-none focus:border-blue-400/40"
 >
 ...
 <span class="mt-2 rounded-full bg-[var(--surface-0)] px-3 py-1 text-xs font-semibold text-[var(--text-secondary)] border border-[var(--border)]/60 
 You
 </span>
 </div>
 ...
 <span class="mt-1 whitespace-nowrap rounded-full bg-[var(--surface-0)] px-2 py-0.5 text-xs font-medium text-[var(--text-secondary)] border border-[var(--border)]/60 
 ...
 >
 <span class="h-full w-px bg-[var(--surface-0)]"></span>
 <span class="absolute h-20 w-1.5 rounded-full bg-[var(--surface-0)] transition group-hover:bg-violet-500"></span>
 </button>
 ...
 {#if $incomingPendingTransfers.length > 0}
 <div class="rounded-xl border border-amber-200/70 bg-[var(--surface-0)] p-4 
 ...
 class="rounded-lg p-1 transition hover:bg-[var(--surface-0)]"
 >
 <X class="h-4 w-4 text-[var(--text-secondary)]" />
 </button>
 </div>
 <div class="mb-4 flex items-center gap-3 rounded-xl bg-[var(--surface-0)] p-3">
 <div
 ...
 class="flex-1 rounded-lg border border-[var(--border)]/60 bg-[var(--surface-0)] px-3 py-2 text-sm text-white outline-none transition focus:border-cyan-500/30 focus:"
 />
 </div>
 ...
 <div class="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-[var(--surface-0)]">
 ...
 <div class="rounded-xl border border-[var(--border)]/60 bg-[var(--surface-0)] p-3">
