<script lang="ts">
  ...
  function levelBg(level: string): string {
    switch (level) {
      ...
      case 'debug': return 'bg-white/10 dark:bg-white/5 text-gray-600 dark:text-gray-400';
  ...
  function sourceBg(source: string): string {
    ...
    switch (normalized) {
      ...
      default: return 'bg-white/10 dark:bg-white/5 text-gray-700 dark:text-gray-300';
    }
  }
...
<div class="p-4 sm:p-6 space-y-6 max-w-6xl mx-auto">
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center gap-3">
      ...
      <button
        onclick={refreshAll}
        class="p-2 hover:bg-white/10 dark:hover:bg-white/5 rounded-lg transition-colors dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400/30"
        title="Refresh all"
      >
    ...
    {#if showDhtSection}
      <div class="px-6 pb-6 space-y-4">
        ...
        {#if dhtHealth}
          ...
          {#if dhtHealth.peerId}
            <div class="p-3 bg-white/8 dark:bg-white/5 rounded-lg">
        ...
        {#if bootstrapHealth}
          ...
          <div class="space-y-2">
            {#each bootstrapHealth.nodes as node}
              <div class="flex items-center justify-between p-3 bg-white/8 dark:bg-white/5 rounded-lg text-xs">
  ...
  <div class="backdrop-blur-xl bg-white/10 dark:bg-white/5 rounded-2xl shadow-lg shadow-black/5 border border-white/20 dark:border-white/10 ring-1 ring-white/10">
    ...
    >
      <div class="flex items-center gap-3">
        <div class="p-2 {miningStatus?.mining ? 'bg-amber-100 dark:bg-amber-900/30' : 'bg-white/10 dark:bg-white/5'} rounded-lg">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2">
            ...
            <select
              ...
              class="text-xs px-2 py-1 bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded dark:text-gray-300"
            >
          ...
          <div class="flex items-center gap-2">
            <button
              ...
              class="text-xs px-2 py-1 bg-white/10 dark:bg-white/5 hover:bg-white/15 dark:hover:bg-white/10 rounded transition-colors flex items-center gap-1 dark:text-gray-300"
            >
              <Copy class="w-3 h-3" />
              Copy
            </button>
