...
<div class="p-4 sm:p-6 max-w-6xl mx-auto">
  ...
  <div class="backdrop-blur-xl bg-white/10 dark:bg-white/5 rounded-2xl shadow-lg shadow-black/5 border border-white/20 dark:border-white/10 ring-1 ring-white/10 p-6 mb-6">
          ...
          <button
            ...
            class="relative flex flex-col items-center gap-2 p-4 rounded-lg border-2 transition-all
              {$settings.theme === option.value
                ...
                : 'border-white/20 dark:border-white/10 hover:border-gray-300 dark:hover:border-gray-500 bg-white/8 dark:bg-white/5'}"
          >
    ...
    <!-- Compact Mode -->
    <div class="flex items-center justify-between py-4 border-t border-white/20 dark:border-white/10">
    ...
    <!-- Navigation Style -->
    <div class="py-4 border-t border-white/20 dark:border-white/10">
    ...
    <div class="pt-4 border-t border-white/20 dark:border-white/10">
      ...
      <div class="p-4 rounded-lg bg-gray-50 dark:backdrop-blur-md bg-white/5 dark:bg-white/5 border border-white/20 dark:border-white/10">
        ...
        <div class="grid grid-cols-2 gap-3">
          <div class="p-3 rounded-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10">
  ...
  {#if isTauri}
    <div class="backdrop-blur-xl bg-white/10 dark:bg-white/5 rounded-2xl shadow-lg shadow-black/5 border border-white/20 dark:border-white/10 ring-1 ring-white/10 p-6 mb-6">
      ...
      <div>
        ...
        <div class="flex items-center gap-3">
          <div class="flex-1 flex items-center gap-2 px-3 py-2.5 bg-white/8 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-lg">
