...
<div class="p-4 sm:p-6 max-w-6xl mx-auto">
 ...
 <p class="text-sm text-white/50">Customize how the app looks</p>
 </div>
 </div>
 ...
 :'border-gray-800/60 hover:border-white/[0.08] bg-white/[0.07]'}"
 >
 ...
 {/if}
 <Icon class="w-6 h-6 {$settings.theme === option.value ?'text-blue-400' :'text-white/50'}" />
 ...
 <!-- Compact Mode -->
 <div class="flex items-center justify-between py-4 border-t border-gray-800/60">
 <div class="flex items-center gap-3">
 <LayoutGrid class="w-5 h-5 text-white/50" />
 <div>
 <p class="font-medium text-white">Compact Mode</p>
 <p class="text-sm text-white/50">Use smaller spacing and font sizes</p>
 </div>
 </div>
 <button
 onclick={toggleCompactMode}
 class="relative w-12 h-6 rounded-full transition-colors
 {$settings.compactMode ?'bg-blue-500/[0.06]0' :'bg-white/[0.05]'}"
 role="switch"
 ...
 <!-- Navigation Style -->
 <div class="py-4 border-t border-gray-800/60">
 ...
 {/if}
 <Icon class="w-6 h-6 {$settings.navStyle === option.value ?'text-blue-400' :'text-white/50'}" />
 ...
 <p class="text-sm text-white/50">Configure where downloaded files are saved</p>
 </div>
 </div>
 ...
 <div class="flex items-center gap-3">
 <div class="flex-1 flex items-center gap-2 px-3 py-2.5 bg-white/[0.07] border border-gray-800/60 rounded-lg">
 ...
 <p class="text-sm text-white/50">Toggle which toast notifications to show</p>
 </div>
 </div>
 ...
 class="flex items-center justify-between gap-3 py-2 px-3 rounded-lg hover:bg-white/[0.05] transition-colors group"
 role="switch"
 ...
 {$settings.notifications?.[option.key] ?'bg-blue-500/[0.06]0' :'bg-white/[0.05]'}">
 <span
 ...
 <p class="text-sm text-white/50">Restore all settings to their default values</p>
 </div>
 <button
