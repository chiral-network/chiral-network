...
<div class="p-4 sm:p-6 space-y-6 max-w-6xl mx-auto">
  <div class="flex items-center justify-between">
    <div>
      <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Mining</h1>
      <p class="text-gray-500 dark:text-gray-400 mt-1">Mine CHI tokens on the Chiral Network</p>
    </div>
    <button
      onclick={refreshAll}
      disabled={isLoading}
      class="p-2 hover:bg-gray-100 dark:hover:bg-white/[0.03] rounded-lg transition-colors disabled:opacity-50 text-gray-600 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-500/30"
  ...
  {:else if !gethStatus?.installed || !gethStatus?.localRunning}
    ...
    <div class="bg-white dark:bg-gray-950 rounded-xl border-t-2 border-t-cyan-500/40  border border-gray-200 dark:border-gray-800/60 p-6">
      <div class="flex items-center gap-3 mb-4">
        ...
        <div>
          <h2 class="font-semibold text-gray-900 dark:text-gray-100">Local Blockchain Node Required</h2>
  ...
  {:else}
    ...
    <div class="bg-white dark:bg-gray-950 rounded-xl border-t-2 border-t-cyan-500/40  border border-gray-200 dark:border-gray-800/60 p-6">
      <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-3">
          <div class="p-2 {isAnyMining ? 'bg-yellow-500/10' : 'bg-gray-100 dark:bg-gray-800'} rounded-lg">
            <Pickaxe class="w-6 h-6 {isAnyMining ? 'text-yellow-600 dark:text-yellow-400' : 'text-gray-500 dark:text-gray-400'}" />
          </div>
          <div>
            <h2 class="font-semibold text-gray-900 dark:text-gray-100">Mining</h2>
            <p class="text-sm text-gray-500">Earn CHI by mining blocks with CPU or GPU</p>
          </div>
        </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
        <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
          <div class="flex items-center gap-2 mb-2">
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400">Hash Rate</span>
          </div>
          <p class="text-2xl font-bold tabular-nums text-gray-900 dark:text-gray-100">
        ...
        <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
          <div class="flex items-center gap-2 mb-2">
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400">Block Height</span>
          </div>
          <p class="text-2xl font-bold tabular-nums text-gray-900 dark:text-gray-100">
        ...
        <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
          <div class="flex items-center gap-2 mb-2">
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400">Total Mined</span>
          </div>
          <p class="text-2xl font-bold tabular-nums text-gray-900 dark:text-gray-100">
        ...
        <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
          <div class="flex items-center gap-2 mb-2">
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400">Session Time</span>
          </div>
          <p class="text-2xl font-bold tabular-nums text-gray-900 dark:text-gray-100">
        ...
        <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
          <div class="flex items-center gap-2 mb-2">
            {#if activeMiningBackend === 'gpu'}
              ...
              <span class="text-sm text-gray-500 dark:text-gray-400">GPUs Active</span>
            {:else}
              <Cpu class="w-4 h-4 text-green-500" />
              <span class="text-sm text-gray-500 dark:text-gray-400">Threads Active</span>
            {/if}
          </div>
          <p class="text-2xl font-bold tabular-nums text-gray-900 dark:text-gray-100">
            {#if activeMiningBackend === 'gpu'}
      ...
      <div class="mb-4 p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
        <div class="flex items-center gap-2 mb-1">
          ...
          <span class="text-sm text-gray-500 dark:text-gray-400">Miner Address</span>
        </div>
        <p class="text-sm font-mono truncate text-gray-600 dark:text-gray-300">
      ...
      <div class="mb-4">
        ...
        <div class="grid grid-cols-2 gap-2">
          <button
            ...
            class="px-3 py-2 rounded-lg border text-sm font-medium transition-colors disabled:opacity-50 {miningMode === 'cpu' ? 'bg-cyan-50 dark:bg-cyan-500/[0.06] border-cyan-500/30 text-cyan-700 dark:text-cyan-300' : 'bg-white dark:bg-gray-950 border-gray-200 dark:border-gray-800/50 text-gray-600 dark:text-gray-300'}"
          >
            CPU Miner
          </button>
          <button
            ...
            disabled={isAnyMining}
            class="px-3 py-2 rounded-lg border text-sm font-medium transition-colors disabled:opacity-50 {miningMode === 'gpu' ? 'bg-cyan-50 dark:bg-cyan-500/[0.06] border-cyan-500/30 text-cyan-700 dark:text-cyan-300' : 'bg-white dark:bg-gray-950 border-gray-200 dark:border-gray-800/50 text-gray-600 dark:text-gray-300'}"
          >
            GPU Miner
          </button>
        </div>
      ...
      {#if miningMode === 'cpu'}
        ...
        <div class="mb-4">
          <label for="cpu-utilization" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">
          ...
          <input
            ...
            disabled={isAnyMining}
            class="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-lg appearance-none cursor-pointer disabled:opacity-50"
          />
      ...
      {:else}
        ...
        <div class="mb-4">
          <label for="gpu-utilization" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">
        ...
        <div class="mb-4">
          ...
          {:else}
            ...
            {#if gpuCapabilities.devices.length === 0}
              <div class="rounded-lg border border-gray-200 dark:border-gray-800/60 bg-gray-100 dark:bg-gray-800 p-3 text-sm text-gray-600 dark:text-gray-300">
                No devices were reported by the miner binary. You can still try starting GPU mining with auto-detection.
              </div>
            {:else}
              <div class="space-y-2 max-h-44 overflow-y-auto rounded-lg border border-gray-200 dark:border-gray-800/60 p-3 bg-gray-100 dark:bg-gray-800">
                {#each gpuCapabilities.devices as device (device.id)}
                  <label class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                    <input
                      ...
                      disabled={isAnyMining}
                      class="rounded border-cyan-500/25 bg-white dark:bg-gray-950"
                    />
      ...
      {#if gpuMiningStatus?.lastError}
        <div class="mb-4 rounded-lg border border-red-500/20 bg-red-500/10 p-3">
          <p class="text-sm text-red-600 dark:text-red-400">{gpuMiningStatus.lastError}</p>
        </div>
      {/if}
    ...
    <!-- Mining History -->
    <div class="bg-white dark:bg-gray-950 rounded-xl border-t-2 border-t-pink-500/40  border border-gray-200 dark:border-gray-800/60">
      <button
      ...
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 class="font-semibold text-gray-900 dark:text-gray-100">Mining History</h2>
            <p class="text-sm text-gray-500">
        ...
        <div class="px-6 pb-6">
          ...
          {#if isLoadingHistory && minedBlocks.length === 0}
            <div class="flex items-center justify-center py-8">
              ...
              <span class="ml-2 text-sm text-gray-500">Scanning blockchain...</span>
            </div>
          {:else if minedBlocks.length === 0}
            <div class="text-center py-8">
              <Pickaxe class="w-10 h-10 text-gray-600 dark:text-gray-300 mx-auto mb-3" />
              <p class="text-sm text-gray-500">No blocks mined yet.</p>
              <p class="text-xs text-gray-500 mt-1">Start mining to earn CHI block rewards.</p>
            </div>
          {:else}
            <!-- Summary Stats -->
            <div class="grid grid-cols-3 gap-3 mb-4">
              <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
                <p class="text-xs text-gray-500">Blocks Mined</p>
                <p class="text-lg font-bold text-gray-900 dark:text-gray-100">{minedBlocks.length}</p>
              </div>
              <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
              ...
              <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
                <p class="text-xs text-gray-500">Reward per Block</p>
                <p class="text-lg font-bold text-gray-900 dark:text-gray-100">{minedBlocks[0]?.rewardChi ?? 0} CHI</p>
              </div>
            </div>
              ...
              <table class="w-full text-sm">
                <thead>
                  <tr class="border-b border-gray-200 dark:border-gray-800/50">
                    ...
                    <th class="text-right py-2 px-3 text-xs font-medium text-gray-500">Difficulty</th>
                  </tr>
                </thead>
                <tbody>
                  {#each minedBlocks as block (block.blockNumber)}
                    <tr class="border-b border-gray-200 dark:border-gray-800/40 hover:bg-gray-100 dark:hover:bg-white/[0.02] transition-colors">
                      <td class="py-2 px-3 font-mono text-xs tabular-nums text-gray-600 dark:text-gray-300">
                      ...
                      <td class="py-2 px-3 text-right text-xs tabular-nums text-gray-500 font-mono">
