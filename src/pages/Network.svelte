...
<div class="max-w-6xl mx-auto p-4 sm:p-6">
 ...
 <div class="mt-4 p-3 bg-violet-950/20 border border-primary-200 rounded-lg">
 ...
 <span class="px-2 py-0.5 text-xs rounded-full bg-yellow-100 text-yellow-600 font-medium">
