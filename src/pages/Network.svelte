...
<div class="max-w-6xl mx-auto p-4 sm:p-6">
 ...
 <p class="text-gray-500 dark:text-white/50 mt-1">Manage blockchain and P2P network connections</p>
 </div>
 <button
 onclick={loadGethStatus}
 disabled={isLoadingGeth}
 class="p-2 hover:bg-gray-100 dark:hover:bg-white/[0.05] rounded-lg transition-colors disabled:opacity-50 focus:outline-none"
 ...
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-xl shadow-gray-200/50 dark:shadow-black/5 border border-gray-200/60 dark:border-white/[0.06] p-6 mb-6">
 <div class="flex items-center justify-between mb-4">
 <div class="flex items-center gap-3">
 <div class="p-2 {gethStatus?.running ?'bg-green-100 dark:bg-green-500/[0.15]' :'bg-white/70 dark:bg-white/[0.05]'} rounded-lg">
 ...
 <p class="text-sm text-gray-400 dark:text-white/40">Chiral Network blockchain connection</p>
 </div>
 </div>
 <div class="flex items-center gap-2">
 {#if gethStatus?.running}
 <span class="flex items-center gap-2 px-3 py-1 bg-green-100 dark:bg-green-500/[0.15] text-green-600 dark:text-green-400 rounded-full text-sm">
 <span class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
 Running
 </span>
 {:else if gethStatus?.installed}
 <span class="flex items-center gap-2 px-3 py-1 bg-white/70 dark:bg-white/[0.05] text-gray-500 dark:text-white/50 rounded-full text-sm">
 <span class="w-2 h-2 bg-gray-200 dark:bg-white/[0.12] rounded-full"></span>
 Stopped
 </span>
 {:else}
 <span class="flex items-center gap-2 px-3 py-1 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 rounded-full text-sm">
 ...
 <div>
 <p class="font-medium text-yellow-800 dark:text-yellow-200">Geth Not Installed</p>
 ...
 <p class="text-xs text-gray-400 dark:text-white/40 text-right">
 ...
 <p class="text-xs text-gray-400 dark:text-white/40">Block Height</p>
 <p class="text-lg font-bold tabular-nums">{gethStatus?.currentBlock?.toLocaleString() || 0}</p>
 </div>
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-3">
 <p class="text-xs text-gray-400 dark:text-white/40">Blockchain Peers</p>
 <p class="text-lg font-bold tabular-nums">{gethStatus?.peerCount || 0}</p>
 </div>
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-3">
 <p class="text-xs text-gray-400 dark:text-white/40">Chain ID</p>
 <p class="text-lg font-bold tabular-nums">{gethStatus?.chainId ||'N/A'}</p>
 </div>
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-3">
 <p class="text-xs text-gray-400 dark:text-white/40">Sync Status</p>
 ...
 <div class="mt-4 p-3 bg-violet-100 dark:bg-violet-950/20 border border-primary-200 rounded-lg">
 ...
 <div class="mt-4 border-t border-gray-200/60 dark:border-white/[0.06] pt-4">
 <div class="flex items-center justify-between mb-3">
 <div class="flex items-center gap-2">
 <Activity class="w-4 h-4 text-gray-400 dark:text-white/40" />
 <span class="text-sm font-medium text-gray-500 dark:text-white/50">Bootstrap Health Check</span>
 </div>
 <button
 onclick={checkBootstrapHealth}
 disabled={isCheckingBootstrap}
 class="text-xs px-2 py-1 bg-white/70 dark:bg-white/[0.05] hover:bg-gray-100 dark:hover:bg-white/[0.05] rounded transition-colors flex items-center gap-1 disabled:opacity-50"
 >
 ...
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-2.5">
 ...
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-2.5">
 <p class="text-xs text-gray-400 dark:text-white/40">Healthy Nodes</p>
 <p class="text-sm font-bold tabular-nums">{bootstrapHealth.healthyNodes} / {bootstrapHealth.totalNodes}</p>
 </div>
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-2.5">
 <p class="text-xs text-gray-400 dark:text-white/40">Last Checked</p>
 ...
 >
 <span class="text-xs text-gray-400 dark:text-white/40">Node Details</span>
 ...
 <div class="flex items-center justify-between p-2.5 bg-white/70 dark:bg-white/[0.05] rounded-lg text-xs">
 <div class="flex items-center gap-2">
 ...
 <span class="text-gray-400 dark:text-white/40 ml-1">({node.region})</span>
 </div>
 </div>
 ...
 {/if}
 {:else}
 <p class="text-xs text-gray-400 dark:text-white/40 text-center py-2">
 ...
 <div class="flex items-center justify-between mb-4">
 <div class="flex items-center gap-3">
 <div class="p-2 {$networkConnected ?'bg-green-100 dark:bg-green-500/[0.15]' :'bg-white/70 dark:bg-white/[0.05]'} rounded-lg">
 <Globe class="w-6 h-6 {$networkConnected ?'text-green-600 dark:text-green-400' :'text-gray-500 dark:text-white/50'}" />
 </div>
 <div>
 <h2 class="font-semibold">P2P Network (DHT)</h2>
 <p class="text-sm text-gray-400 dark:text-white/40">Kademlia DHT file sharing and peer discovery</p>
 </div>
 </div>
 <div class="flex items-center gap-2">
 <span class="flex items-center gap-2 px-3 py-1 {$networkConnected ?'bg-green-100 dark:bg-green-500/[0.15] text-green-600 dark:text-green-400' :'bg-white/70 dark:bg-white/[0.05] text-gray-500 dark:text-white/50'} rounded-full text-sm">
 <span class="w-2 h-2 rounded-full {$networkConnected ?'bg-green-500 animate-pulse' :'bg-gray-200 dark:bg-white/[0.12]'}"></span>
 ...
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-3">
 <p class="text-xs text-gray-400 dark:text-white/40">DHT Peers</p>
 <p class="text-lg font-bold tabular-nums">{$networkStats.connectedPeers}</p>
 </div>
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-3">
 <p class="text-xs text-gray-400 dark:text-white/40">Discovered Peers</p>
 ...
 <!-- Peer ID -->
 {#if localPeerId}
 <div class="mb-4 p-3 bg-white/70 dark:bg-white/[0.05] rounded-lg">
 <div class="text-xs text-gray-400 dark:text-white/40 mb-1">Your Peer ID</div>
 ...
 <div class="flex items-center justify-between mb-3">
 <div class="flex items-center gap-2">
 <HeartPulse class="w-4 h-4 text-gray-400 dark:text-white/40" />
 <span class="text-sm font-medium text-gray-500 dark:text-white/50">Health Check</span>
 </div>
 <button
 ...
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-2.5">
 <p class="text-xs text-gray-400 dark:text-white/40">Connected Peers</p>
 <p class="text-sm font-bold tabular-nums">{dhtHealth.connectedPeerCount}</p>
 </div>
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-2.5">
 <p class="text-xs text-gray-400 dark:text-white/40">Kademlia Peers</p>
 <p class="text-sm font-bold tabular-nums">{dhtHealth.kademliaPeers}</p>
 </div>
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-2.5">
 <p class="text-xs text-gray-400 dark:text-white/40">Shared Files</p>
 ...
 class="w-full flex items-center justify-between text-left py-2"
 >
 <span class="text-xs text-gray-400 dark:text-white/40">Advanced Details</span>
 ...
 <div class="space-y-2">
 {#if dhtHealth.peerId}
 <div class="p-2.5 bg-white/70 dark:bg-white/[0.05] rounded-lg">
 <p class="text-xs text-gray-400 dark:text-white/40 mb-1">Peer ID</p>
 ...
 <div class="p-2.5 bg-white/70 dark:bg-white/[0.05] rounded-lg">
 <p class="text-xs text-gray-400 dark:text-white/40 mb-2">Listening Addresses ({dhtHealth.listeningAddresses.length})</p>
 <div class="space-y-1.5">
 {#each dhtHealth.listeningAddresses as addr}
 <div class="flex items-start gap-2 text-xs">
 <span class="shrink-0 px-1.5 py-0.5 rounded text-[10px] font-semibold {addrType(addr) ==='IPv6' ?'bg-purple-100 dark:bg-purple-500/[0.15] text-purple-600 dark:text-purple-400 dark:text-purple-400' : addrType(addr) ==='IPv4' ?'bg-blue-100 dark:bg-blue-500/[0.15] text-blue-600 dark:text-blue-400' :'bg-white/70 dark:bg-white/[0.05] text-gray-500 dark:text-white/50'}">
 {addrType(addr)}
 </span>
 ...
 <div class="p-2.5 bg-white/70 dark:bg-white/[0.05] rounded-lg">
 <p class="text-xs text-gray-400 dark:text-white/40 mb-2">DHT Bootstrap Nodes</p>
 <div class="space-y-1.5">
 ...
 <span class="shrink-0 px-1.5 py-0.5 rounded text-[10px] font-semibold {addrType(node.address) ==='IPv6' ?'bg-purple-100 dark:bg-purple-500/[0.15] text-purple-600 dark:text-purple-400 dark:text-purple-400' : addrType(node.address) ==='IPv4' ?'bg-blue-100 dark:bg-blue-500/[0.15] text-blue-600 dark:text-blue-400' :'bg-white/70 dark:bg-white/[0.05] text-gray-500 dark:text-white/50'}">
 ...
 <div class="p-2.5 bg-white/70 dark:bg-white/[0.05] rounded-lg">
 <p class="text-xs text-gray-400 dark:text-white/40 mb-1">Active Protocols ({dhtHealth.protocols.length})</p>
 <div class="flex flex-wrap gap-1.5">
 {#each dhtHealth.protocols as protocol}
 <span class="px-2 py-0.5 bg-violet-100 dark:bg-violet-900/20 text-primary-700 dark:text-primary-300 text-xs rounded-full font-mono">
 {protocol}
 </span>
 {/each}
 </div>
 ...
 <!-- Traffic Statistics -->
 <div class="border-t border-gray-200/60 dark:border-white/[0.06] pt-4 mt-4">
 <div class="flex items-center gap-2 mb-3">
 <Activity class="w-4 h-4 text-gray-400 dark:text-white/40" />
 <span class="text-sm font-medium text-gray-500 dark:text-white/50">Traffic Statistics</span>
 </div>
 <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-lg p-3">
 <div class="flex items-center gap-2 mb-1">
 <ArrowDownToLine class="w-3.5 h-3.5 text-green-500" />
 <p class="text-xs text-gray-400 dark:text-white/40">Download Speed</p>
 </div>
 ...
 <p class="text-xs text-gray-400 dark:text-white/40">Upload Speed</p>
 </div>
 ...
 <p class="text-xs text-gray-400 dark:text-white/40">Total Downloaded</p>
 </div>
 ...
 <p class="text-xs text-gray-400 dark:text-white/40">Total Uploaded</p>
 </div>
 ...
 <div class="border-t border-gray-200/60 dark:border-white/[0.06] pt-4 mt-4">
 <div class="flex items-center gap-2 mb-3">
 <Globe class="w-4 h-4 text-gray-400 dark:text-white/40" />
 <span class="text-sm font-medium text-gray-500 dark:text-white/50">NAT Traversal</span>
 {#if relayReservations.some(r => r.active)}
 <span class="px-2 py-0.5 text-xs rounded-full bg-green-100 dark:bg-green-500/[0.15] text-green-600 dark:text-green-400 font-medium">
 Relay Active
 </span>
 ...
 <div class="flex items-center justify-between p-2 bg-white/70 dark:bg-white/[0.05] rounded-lg text-xs">
 <div class="flex items-center gap-2">
 ...
 {:else if $networkConnected}
 <p class="text-xs text-gray-400 dark:text-white/40 mb-3">
 ...
 <div class="mb-2">
 <p class="text-xs text-gray-400 dark:text-white/40 mb-1.5">Hole-Punch Events (DCUtR)</p>
 <div class="space-y-1">
 {#each holePunchEvents.slice(0, 5) as event}
 <div class="flex items-center justify-between p-1.5 text-xs {event.success ?'text-green-600 dark:text-green-400' :'text-red-700 dark:text-red-300'}">
 ...
 <div class="border-t border-gray-200/60 dark:border-white/[0.06] pt-4 mt-4">
 <div class="flex items-center gap-2 mb-3">
 <Radio class="w-4 h-4 text-gray-400 dark:text-white/40" />
 <span class="text-sm font-medium text-gray-500 dark:text-white/50">Connected Peers</span>
 <span class="px-2 py-0.5 text-xs rounded-full bg-white/70 dark:bg-white/[0.05] text-gray-500 dark:text-white/50">
 {filteredPeers.length}
 </span>
 </div>

 {#if filteredPeers.length === 0}
 <div class="text-center py-4 text-gray-400 dark:text-white/40">
 ...
 <div class="p-3 bg-white/70 dark:bg-white/[0.05] rounded-lg hover:bg-gray-100 dark:hover:bg-white/[0.05] transition-colors">
 <div class="flex items-start justify-between gap-3">
 <div class="flex-1 min-w-0">
 <div class="font-mono text-sm break-all">{peer.id}</div>
 {#if peer.address}
 <div class="text-xs text-gray-400 dark:text-white/40 mt-1">Address: {peer.address}</div>
 {/if}
 </div>
 <button
 onclick={() => pingPeer(peer.id)}
 class="flex items-center gap-1 px-3 py-1.5 bg-violet-500/80 border border-primary-400/30 text-white text-sm rounded hover:bg-violet-500/90 transition shrink-0"
 ...
 <!-- Blacklist Section -->
 <div class="bg-white/70 dark:bg-white/[0.05] rounded-xl shadow-gray-200/50 dark:shadow-black/5 border border-gray-200/60 dark:border-white/[0.06] p-6 mt-6">
 ...
 <p class="text-sm text-gray-400 dark:text-white/40">Block addresses from file transfers</p>
 </div>
 {#if $blacklist.length > 0}
 <span class="px-2 py-0.5 text-xs rounded-full bg-red-100 dark:bg-red-900/20 text-red-600 dark:text-red-400 font-medium">
 {$blacklist.length}
 </span>
 {/if}
 </div>
 ...
 class="flex-1 px-3 py-2 text-sm border border-gray-200/60 dark:border-white/[0.06] rounded-lg bg-white/70 dark:bg-white/[0.05] text-gray-900 dark:text-white/90 placeholder:text-gray-400 dark:text-white/40 focus:border-violet-500"
 ...
 class="w-48 px-3 py-2 text-sm border border-gray-200/60 dark:border-white/[0.06] rounded-lg bg-white/70 dark:bg-white/[0.05] text-gray-900 dark:text-white/90 placeholder:text-gray-400 dark:text-white/40 focus:border-violet-500"
 onkeydown={(e: KeyboardEvent) => { if (e.key ==='Enter') addToBlacklist(); }}
 />
 <button
 ...
 <!-- Entries List -->
 {#if $blacklist.length === 0}
 <div class="text-center py-6 text-gray-400 dark:text-white/40">
 ...
 <div class="flex items-center justify-between gap-3 p-3 bg-white/70 dark:bg-white/[0.05] rounded-lg group">
 <div class="flex-1 min-w-0">
 <div class="font-mono text-sm truncate" title={entry.address}>
 {truncateAddress(entry.address)}
 </div>
 <div class="flex items-center gap-2 mt-0.5">
 <span class="text-xs text-gray-400 dark:text-white/40">{entry.reason}</span>
 <span class="text-xs text-gray-500 dark:text-white/50">&middot;</span>
 <span class="text-xs text-gray-500 dark:text-white/50">{new Date(entry.addedAt).toLocaleDateString()}</span>
 </div>
 </div>
 <button
 onclick={() => removeFromBlacklist(entry.address)}
 class="p-1.5 text-gray-500 dark:text-white/50 hover:text-red-500 hover:bg-red-500/[0.1] rounded-lg transition-colors opacity-0 group-hover:opacity-100"
