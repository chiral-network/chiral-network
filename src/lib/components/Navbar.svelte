...
<nav class="sticky top-0 z-50 bg-[var(--surface-1)] border-b border-[var(--border)]">
 ...
 <span class="text-lg font-bold text-[var(--text-primary)] hidden sm:inline">Chiral Network</span>
 </div>
 ...
 class="flex items-center px-2 py-1.5 rounded-lg transition-colors duration-150 text-sm
 ...
 <button
 onclick={() => navigate(item.path)}
 class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg transition-colors duration-150 text-sm whitespace-nowrap
 {currentPage === item.path
 ...
 class="flex items-center gap-1 px-3 py-1.5 rounded-lg transition-colors duration-150 text-sm whitespace-nowrap
 {isMoreActive
 ? 'bg-[var(--surface-2)] text-[var(--text-primary)]'
 : 'text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)]'}"
 title="More"
 ...
 {#if moreMenuOpen}
 <div
 class="fixed w-48 overflow-y-auto bg-[var(--surface-1)] rounded-xl border border-[var(--border)] py-1 z-50"
 ...
 class="hidden sm:flex items-center gap-1.5 px-3 py-1.5 text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)] rounded-lg transition-colors duration-150 text-sm"
 title="Logout"
 >
 ...
 class="md:hidden p-1.5 text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-2)] rounded-lg transition-colors duration-150"
 >
 {#if mobileMenuOpen}
 <X class="w-5 h-5" />
 {:else}
