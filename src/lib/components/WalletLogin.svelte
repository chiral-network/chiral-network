  ...
  <div class="bg-white dark:bg-gray-950 rounded-lg shadow-sm p-8">
    ...
    <div class="flex gap-3 mb-6">
      <button
        ...
        class="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg transition {method === 'privateKey' ? 'bg-primary-600 text-white' : 'bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-600 dark:text-gray-300'}"
      >
      ...
      <button
        ...
        class="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg transition {method === 'mnemonic' ? 'bg-primary-600 text-white' : 'bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-600 dark:text-gray-300'}"
      >
    ...
    {#if method === 'privateKey'}
      <div class="mb-6">
        ...
        <input
          ...
          class="w-full px-4 py-2 border border-gray-200/60 dark:border-gray-800 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent font-mono text-sm bg-white dark:bg-gray-900 dark:text-white"
