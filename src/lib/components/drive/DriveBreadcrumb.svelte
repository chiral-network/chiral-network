...
<nav class="flex items-center gap-1 text-sm text-gray-600 dark:text-gray-400 flex-wrap">
  <button
    ...
    class="flex items-center gap-1 hover:text-gray-900 dark:hover:text-white transition font-medium px-1.5 py-0.5 rounded hover:bg-white/10 dark:hover:bg-white/5"
  >
  ...
  {#each breadcrumb as crumb, i}
    ...
    <button
      ...
      class="hover:text-gray-900 dark:hover:text-white transition font-medium px-1.5 py-0.5 rounded hover:bg-white/10 dark:hover:bg-white/5
