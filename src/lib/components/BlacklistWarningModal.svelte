...
>
 ...
 <div>
 <h3 class="font-semibold text-lg text-white/90">Blacklisted Address</h3>
 <p class="text-sm text-white/40">This address is on your blacklist</p>
 </div>
 </div>

 <!-- Details -->
 <div class="bg-white/[0.05] border border-white/[0.06] rounded-lg p-4 mb-4 space-y-2">
 <div class="flex justify-between items-start gap-2">
 <span class="text-xs text-white/40 shrink-0">Address</span>
 <span class="text-sm font-mono text-white/90 text-right break-all">{formatAddr(address)}</span>
 </div>
 <div class="flex justify-between items-start gap-2">
 <span class="text-xs text-white/40 shrink-0">Reason</span>
 <span class="text-sm text-white/90 text-right">{reason}</span>
 </div>
 </div>
