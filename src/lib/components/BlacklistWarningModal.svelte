...
>
  <div class="bg-white dark:bg-gray-950 rounded-xl border border-gray-200 dark:border-gray-800/60 p-6 max-w-md w-full mx-4">
    ...
    <div class="flex items-center gap-3 mb-4">
      ...
      <div>
        <h3 class="font-semibold text-lg text-gray-900 dark:text-gray-100">Blacklisted Address</h3>
    ...
    <div class="bg-gray-900/50 rounded-lg p-4 mb-4 space-y-2">
      <div class="flex justify-between items-start gap-2">
        ...
        <span class="text-sm font-mono text-gray-900 dark:text-gray-100 text-right break-all">{formatAddr(address)}</span>
      </div>
      <div class="flex justify-between items-start gap-2">
        <span class="text-xs text-gray-500 shrink-0">Reason</span>
        <span class="text-sm text-gray-900 dark:text-gray-100 text-right">{reason}</span>
      </div>
    </div>
