...
<!-- Mobile top bar -->
<div class="md:hidden sticky top-0 z-50 flex items-center justify-between h-14 px-3 bg-white dark:bg-gray-950 shadow-sm border-b border-gray-200/60 dark:border-gray-800">
  ...
  <div class="flex items-center gap-2">
    ...
    <button
      ...
      class="p-1.5 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition"
    >
      {#if mobileOpen}
        <X class="w-5 h-5" />
      {:else}
...
{#if mobileOpen}
  ...
  <div class="md:hidden fixed top-14 left-0 right-0 z-50 bg-white dark:bg-gray-950 border-b border-gray-200/60 dark:border-gray-800 shadow-sm max-h-[calc(100vh-3.5rem)] overflow-y-auto">
    <div class="px-3 py-2 space-y-1">
        ...
        <button
          ...
          class="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg transition text-sm
            {currentPage === item.path
              ? 'border-l-2 border-primary-600 dark:border-primary-400 text-primary-600 dark:text-primary-400 bg-transparent'
      ...
      <button
        ...
        class="flex items-center gap-3 w-full px-3 py-2.5 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition text-sm"
      >
...
<!-- Desktop sidebar -->
<aside
  class="hidden md:flex fixed top-0 left-0 z-40 h-screen flex-col bg-white dark:bg-gray-950 border-r border-gray-200/60 dark:border-gray-800 shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-[width] duration-200
    {collapsed ? 'w-16' : 'w-48'}"
>
  <!-- Logo + collapse toggle -->
  <div class="flex items-center h-14 px-3 border-b border-gray-200/60 dark:border-gray-800 shrink-0 overflow-hidden
    ...
    {#if !collapsed}
      <button
        ...
        class="p-1 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-md transition shrink-0"
  ...
  <!-- Network status -->
  <div class="flex items-center gap-3 px-3 py-2 border-b border-gray-200/60 dark:border-gray-800 shrink-0
  ...
  <!-- Bottom section -->
  <div class="px-2 pb-3 space-y-1 border-t border-gray-200/60 dark:border-gray-800 pt-3 shrink-0">
    <!-- Expand toggle (only when collapsed) -->
    {#if collapsed}
      <button
        onclick={toggleCollapse}
        class="flex items-center justify-center w-full py-2 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition text-sm"
    ...
    <button
      onclick={handleLogout}
      class="flex items-center gap-3 w-full py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition text-sm
        {collapsed ? 'justify-center px-0' : 'px-3'}"
