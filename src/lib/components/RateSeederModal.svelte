...
>
 ...
 <!-- Header -->
 <div class="mb-4">
 <h3 class="font-semibold text-lg text-gray-900 dark:text-white/90">Rate This Download</h3>
 <p class="text-sm text-gray-400 dark:text-white/40 mt-1">
 How was your experience downloading <span class="font-medium text-gray-500 dark:text-white/50">{fileName}</span>?
 </p>
 </div>

 <!-- Seeder info -->
 <div class="bg-white/70 dark:bg-white/[0.05] border border-gray-200/60 dark:border-white/[0.06] rounded-lg p-3 mb-4">
 <div class="flex justify-between items-center">
 <span class="text-xs text-gray-400 dark:text-white/40">Seeder</span>
 <span class="text-sm font-mono text-gray-900 dark:text-white/90">{formatAddr(seederWallet)}</span>
 </div>
 </div>
 ...
 >
 <Star
 class="w-8 h-8 transition-colors {(hoveredScore || selectedScore) >= star ?'text-yellow-600 dark:text-yellow-400 dark:text-yellow-400 fill-yellow-400' :'text-gray-500 dark:text-white/50/40/40'}"
 />
 </button>
 {/each}
 </div>
 <span class="text-sm text-gray-400 dark:text-white/40 mt-1">
 ...
 <!-- Comment -->
 <div class="mb-5">
 <label for="rating-comment" class="block text-sm font-medium text-gray-500 dark:text-white/50 mb-1">
 Comment (optional)
 </label>
 <textarea
 id="rating-comment"
 ...
 class="w-full px-3 py-2 bg-white/70 dark:bg-white/[0.05] border border-gray-200/60 dark:border-white/[0.06] rounded-lg text-sm text-gray-900 dark:text-white/90 placeholder:text-gray-400 dark:text-white/40 focus:outline-none focus:border-gray-200/60 dark:border-white/[0.06] resize-none"
 ></textarea>
 <p class="text-xs text-gray-500 dark:text-white/50 mt-1 text-right">{comment.length}/500</p>
 </div>
 ...
 class="flex-1 px-4 py-2.5 bg-violet-500/80 border border-primary-400/30 text-white rounded-lg text-sm font-medium hover:bg-violet-500/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
 >
