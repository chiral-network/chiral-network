...
>
 <div class="cyber-panel w-full max-w-md overflow-hidden">
 <!-- Header -->
 <div class="flex items-center justify-between p-5 pb-4 border-b border-gray-800/60">
 ...
 <button
 onclick={onClose}
 class="p-1.5 text-white/50 hover:text-white/70 rounded-lg hover:bg-white/[0.05] transition-colors
 ...
 <p class="text-sm font-medium text-white/50">No files in Drive</p>
 <p class="text-xs text-white/40 mt-1">Upload files in the Drive page first</p>
 </div>
 {:else}
 <!-- Select all -->
 <div class="px-4 py-2.5 border-b border-gray-800/60 bg-white/[0.04]">
 <button
 onclick={toggleAll}
 class="flex items-center gap-2 text-xs font-medium text-white/50 hover:text-white/70 transition-colors
 focus:outline-none focus:underline"
 >
 <div class="w-4.5 h-4.5 rounded border-2 flex items-center justify-center flex-shrink-0
 {selected.size === files.length && files.length > 0 ?'border-blue-400 bg-blue-500/[0.06]0' :'border-gray-800/60'}">
 ...
 {selected.has(file.id) ?'bg-blue-500/[0.06]/50' :'hover:bg-white/[0.05]'}
 ...
 {selected.has(file.id) ?'border-blue-400 bg-blue-500/[0.06]0' :'border-gray-800/60'}">
 ...
 <!-- Footer -->
 <div class="flex items-center justify-between p-4 border-t border-gray-800/60 bg-white/[0.04]">
 ...
 <button
 onclick={onClose}
 class="px-3 py-1.5 text-sm font-medium text-white/70 border border-gray-800/60 rounded-lg
