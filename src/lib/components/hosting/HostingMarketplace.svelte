...
<div class="rounded-xl border border-[var(--border)]/60 bg-[var(--surface-1)] overflow-hidden">
 ...
 {$settings.hostingConfig.enabled ?'bg-blue-500/[0.06]0' :'bg-[var(--surface-1)]'}"
 role="switch"
 ...
 class="w-24 px-3 py-2 text-sm bg-[var(--surface-1)] border border-[var(--border)]/60 rounded-lg text-white tabular-nums
 ...
 class="w-32 px-3 py-2 text-sm bg-[var(--surface-1)] border border-[var(--border)]/60 rounded-lg text-white tabular-nums
 focus:border-violet-400 focus:outline-none focus:ring-blue-400/20/20"
 />
 ...
 {$settings.hostingConfig.autoAcceptByElo ?'bg-blue-500/[0.06]0' :'bg-[var(--surface-1)]'}"
 role="switch"
 ...
 <p class="text-[11px] text-[var(--text-tertiary)] mt-1.5 leading-tight">
...
<div class="rounded-xl border border-[var(--border)]/60 bg-[var(--surface-1)] p-5 
 ...
 class="text-xs bg-[var(--surface-1)] border border-[var(--border)]/60 rounded-lg px-2.5 py-1.5 text-white/70
 focus:border-violet-400 focus:outline-none focus:ring-blue-400/20/20"
 >
 ...
 class="p-2 text-[var(--text-secondary)] hover:text-white/70 rounded-lg hover:bg-[var(--surface-1)] transition-colors
 ...
 <p class="text-xs mt-1 text-[var(--text-tertiary)]">
 ...
 <div class="group p-4 rounded-xl border border-[var(--border)]/60 bg-[var(--surface-1)]
 ...
 {/if}
 <span class="relative inline-flex h-2.5 w-2.5 rounded-full {host.isOnline ?'bg-green-500' :'bg-[var(--surface-1)]'}"></span>
 </span>
