...
<div class="rounded-xl border border-gray-800/60 bg-white/[0.07] backdrop-blur-xl  backdrop-blur overflow-hidden">
 <div class="flex items-center justify-between gap-4 p-5 pb-4">
 <div class="flex items-center gap-3">
 <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-white/[0.05]">
 ...
 {$settings.hostingConfig.enabled ?'bg-blue-500/[0.06]0' :'bg-white/[0.05]'}"
 role="switch"
 ...
 class="w-24 px-3 py-2 text-sm bg-white/[0.06] border border-gray-800/60 rounded-lg text-white tabular-nums
 focus:border-violet-400 focus:outline-none focus:ring-blue-400/20/20"
 />
 ...
 class="w-32 px-3 py-2 text-sm bg-white/[0.06] border border-gray-800/60 rounded-lg text-white tabular-nums
 focus:border-violet-400 focus:outline-none focus:ring-blue-400/20/20"
 />
 ...
 {$settings.hostingConfig.autoAcceptByElo ?'bg-blue-500/[0.06]0' :'bg-white/[0.05]'}"
 role="switch"
 ...
 <p class="text-[11px] text-white/40 mt-1.5 leading-tight">
 Auto-accept proposals from peers at or above this reputation score.
 </p>
 </div>
 </div>

 <div class="mt-5 flex items-center gap-3 pt-4 border-t border-gray-800/60">
 <button
 onclick={onPublish}
 ...
 onclick={onUnpublish}
 disabled={hostingPublishing}
 class="px-4 py-2 text-sm font-medium text-white/50 border border-gray-800/60 rounded-lg
...
<div class="rounded-xl border border-gray-800/60 bg-white/[0.07] backdrop-blur-xl p-5  backdrop-blur">
 ...
 class="text-xs bg-white/[0.06] border border-gray-800/60 rounded-lg px-2.5 py-1.5 text-white/70
 focus:border-violet-400 focus:outline-none focus:ring-blue-400/20/20"
 >
 ...
 class="p-2 text-white/50 hover:text-white/70 rounded-lg hover:bg-white/[0.05] transition-colors
 ...
 <div class="flex h-16 w-16 items-center justify-center rounded-xl bg-white/[0.04] mb-4">
 ...
 <div class="group p-4 rounded-xl border border-gray-800/60 bg-white/[0.04]
 ...
 {/if}
 <span class="relative inline-flex h-2.5 w-2.5 rounded-full {host.isOnline ?'bg-green-500' :'bg-white/[0.06]'}"></span>
 </span>
