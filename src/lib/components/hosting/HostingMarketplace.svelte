<script lang="ts">
 ...
 if (score >= 60) return'bg-blue-500/[0.15] text-blue-800';
...
<div class="rounded-xl bg-white/[0.05] shadow-black/5 border border-white/[0.06] overflow-hidden">
 ...
 <Settings2 class="h-4.5 w-4.5 text-white/40" />
 </div>
 <div>
 <h2 class="font-semibold text-base text-white/90">Host Settings</h2>
 ...
 {$settings.hostingConfig.enabled ?'bg-violet-500' :'bg-white/[0.05]'}"
 role="switch"
 ...
 {$settings.hostingConfig.autoAcceptByElo ?'bg-violet-500' :'bg-white/[0.05]'}"
 role="switch"
 ...
 />
 <span class="text-xs text-white/40 font-medium">Min Elo</span>
 </div>
 ...
 <div class="mt-5 flex items-center gap-3 pt-4 border-t border-white/[0.06]">
 <button
 onclick={onPublish}
 ...
 onclick={onUnpublish}
 disabled={hostingPublishing}
 class="px-4 py-2 text-sm font-medium text-white/50 border border-white/[0.06] rounded-lg
...
<div class="rounded-xl bg-white/[0.05] p-5 shadow-black/5 border border-white/[0.06]">
 ...
 <div>
 <h2 class="font-semibold text-base text-white/90">Available Hosts</h2>
 <p class="text-xs text-white/40 mt-0.5">
 {#if loadingHosts}
 ...
 class="p-2 text-white/50 hover:text-white/50 rounded-lg hover:bg-white/[0.05] transition-colors
 ...
 <p class="text-sm font-medium text-white/40">No hosts available</p>
 ...
 <div class="group p-4 rounded-xl border border-white/[0.06] bg-white/[0.05]
 ...
 {/if}
 <span class="relative inline-flex h-2.5 w-2.5 rounded-full {host.isOnline ?'bg-green-500' :'bg-white/[0.12]'}"></span>
 </span>
 <span class="text-sm font-semibold text-white/90 font-mono">
