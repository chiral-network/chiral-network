...
"
 ...
 class="flex items-center gap-2 rounded-xl bg-violet-600/100 px-4 py-2 text-sm font-medium text-white transition-colors
 hover:bg-violet-500 focus:outline-none focus:border-blue-400/40/50 
