...
<div class="rounded-xl border p-4 transition-colors
 ...
 :'border-[var(--border)]/60 bg-[var(--surface-1)] 
 
 <div class="flex items-center justify-between gap-4 flex-wrap">
 <div class="flex items-center gap-3">
 <!-- Status indicator -->
 <div class="relative flex h-10 w-10 items-center justify-center rounded-xl
 {serverRunning ?'bg-green-500/[0.08]' :'bg-[var(--surface-1)]'}">
 <Server class="h-5 w-5 {serverRunning ?'text-green-400' :'text-[var(--text-tertiary)]'}" />
 {#if serverRunning}
