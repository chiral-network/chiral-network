...
>
  <div class="bg-white dark:bg-gray-950 rounded-2xl shadow-sm border border-gray-200/60 dark:border-gray-800 w-full max-w-lg overflow-hidden">
    <!-- Header -->
    ...
    <div class="p-5 space-y-5 max-h-[70vh] overflow-y-auto">
      ...
      <div class="grid grid-cols-3 gap-3">
        <div class="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-gray-50 dark:bg-gray-900/40">
      ...
      <div>
        ...
        <textarea
          ...
          class="w-full p-3 text-sm font-mono bg-gray-50 dark:bg-gray-900/50 border border-gray-200/60 dark:border-gray-800 rounded-xl text-gray-900 dark:text-white placeholder-gray-400
            focus:ring-2 focus:ring-primary-400/20 focus:border-primary-400 focus:outline-none resize-none transition-all"
        ></textarea>

        {#if showDrivePicker}
          <div class="mt-2 max-h-40 overflow-y-auto rounded-xl border border-gray-200/60 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/30 divide-y divide-gray-100 dark:divide-gray-700/40">
            ...
            {:else}
              {#each driveFiles as file (file.id)}
                <button
                  ...
                  class="flex items-center justify-between w-full px-3 py-2.5 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors
    ...
    <!-- Footer actions -->
    <div class="flex justify-end gap-3 p-5 pt-4 border-t border-gray-100 dark:border-gray-700/60 bg-gray-50/50 dark:bg-gray-950">
      <button
        onclick={onClose}
        class="px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-200/60 dark:border-gray-800 rounded-xl
      ...
      <button
        ...
        class="flex items-center gap-2 px-5 py-2.5 text-sm font-semibold bg-primary-600 hover:bg-primary-700 text-white rounded-xl transition-all
          shadow-sm shadow-primary-500/20 hover:shadow-sm hover:shadow-primary-500/25 active:scale-[0.98]
