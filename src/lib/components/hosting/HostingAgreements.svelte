...
{#if !loadingAgreements && incomingProposals.length > 0}
 ...
 <div class="flex items-center justify-between gap-3 p-4 rounded-xl bg-black/80 border border-indigo-100">
 <div class="min-w-0">
...
<div class="rounded-xl border border-gray-800/60 bg-white/[0.07] backdrop-blur-xl  backdrop-blur overflow-hidden">
 ...
 focus:outline-none focus:ring-inset focus:ring-blue-400/20/30"
 ...
 {#if showAgreements}
 <div class="border-t border-gray-800/60 p-5 pt-4">
 {#if loadingAgreements}
 ...
 <div class="flex h-14 w-14 items-center justify-center rounded-xl bg-white/[0.04] mb-3">
 ...
 :'border-gray-800/60 bg-white/[0.04] hover:border-[var(--border)]'}">
 ...
 class="text-xs font-medium px-3 py-1.5 text-white/50 border border-gray-800/60 rounded-lg
 hover:bg-white/[0.05] transition-colors focus:outline-none focus:border-blue-400/40"
 >
 Deny
 </button>
 </div>
...
{#if !loadingAgreements && hostedFiles.length > 0}
 ...
 <div class="space-y-2 rounded-xl border border-gray-800/60 divide-y divide-white/[0.06] overflow-hidden">
