...
<div class="rounded-xl border border-[var(--border)]/60 bg-[var(--surface-0)] p-5 
 ...
 class="w-full rounded-xl border border-[var(--border)]/60 bg-[var(--surface-0)] px-4 py-2.5 text-sm text-white placeholder:text-[var(--text-secondary)] transition-all
 focus:border-cyan-500/30 focus:bg-[var(--surface-0)] focus:outline-none focus:ring-cyan-500/20
"
 />
 </div>
 ...
 rounded-lg hover:bg-[var(--surface-0)] transition-colors
 ...
 :'border-[var(--border)]/60 bg-[var(--surface-0)] hover:border-[var(--border)] hover:bg-[var(--surface-0)]'}"
 >
 <div class="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--surface-0)]">
 ...
 <div class="flex items-center justify-between px-3 py-2 hover:bg-[var(--surface-1)]/80 transition-colors group">
 ...
 :'bg-[var(--surface-0)] cursor-not-allowed'}
