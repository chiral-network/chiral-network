...
<div class="rounded-xl border border-[var(--border)]/60 bg-[var(--surface-0)] p-5 
 ...
 <div class="flex h-7 w-7 items-center justify-center rounded-lg bg-[var(--surface-0)]">
 ...
 <div class="group rounded-xl border border-[var(--border)]/60 bg-[var(--surface-0)] p-4 transition-all
...
">
 ...
 {:else}
 <span class="inline-flex items-center rounded-full bg-[var(--surface-0)] px-2 py-0.5 text-[10px] font-medium text-[var(--text-secondary)] uppercase tracking-wide">
 Local
 </span>
 {/if}
 </div>
 ...
 <span class="rounded-xl bg-[var(--surface-0)] px-1.5 py-0.5 text-[10px] font-medium text-[var(--text-secondary)]">
 {file.path}
 </span>
 {/each}
 ...
 class="rounded-lg p-2 text-[var(--text-secondary)] transition-colors hover:bg-[var(--surface-0)] hover:text-[var(--text-secondary)]
