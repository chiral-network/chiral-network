...
export function statusColor(status: string): string {
  switch (status) {
    case 'proposed': return 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400';
    ...
    case 'expired': return 'bg-gray-100 text-gray-600 dark:bg-gray-900 dark:text-gray-400';
