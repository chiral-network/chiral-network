...
- **23 fixed** total: BUG-001, BUG-002, FM-A01/02, FM-A03 (X-Owner signed-challenge auth), FM-A06, FM-A07/A08, FM-A09, FM-A10/A11, FM-A12 (closed via FM-A03), FM-A13, FM-A14, FM-A15, FM-A16, FM-A17, FM-A18, FM-A19, FM-A20, FM-A21, FM-A22, FM-A23.
- **2 still filed** for follow-up: FM-A04/A05 (relay register open-proxy + hijack — needs ownership signature on `register_share`/`register_site` plus an origin-URL allowlist), FM-A24/A25/A26 (minor invariant + UX issues).
