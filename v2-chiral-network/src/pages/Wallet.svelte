...
{#if mode === 'select'}
  <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 dark:from-blue-700 dark:to-purple-800 p-6">
    <div class="max-w-md w-full">
      <div class="text-center mb-8">
        <div class="inline-flex items-center justify-center w-20 h-20 bg-white dark:bg-gray-800 rounded-full mb-4">
          <Wallet class="w-10 h-10 text-blue-600 dark:text-blue-400" />
        </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">Get Started</h2>
        ...
        <button
          ...
          class="w-full flex items-center justify-center gap-3 px-6 py-4 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition"
        >
...
{:else if mode === 'create'}
  <div class="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 dark:from-blue-700 dark:to-purple-800 py-12">
