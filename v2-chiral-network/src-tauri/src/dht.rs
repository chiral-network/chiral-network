...
pub fn get_bootstrap_nodes() -> Vec<String> {
    vec![
        ...
        "/ip4/130.245.173.73/tcp/4001/p2p/12D3KooWLmBXaMfKzdEFqKypZjDDuM6dRRc4X6iZCSiByaYAbZqH".to_string(),
        "/ip6/2002:82f5:ad49::1/tcp/4001/p2p/12D3KooWLmBXaMfKzdEFqKypZjDDuM6dRRc4X6iZCSiByaYAbZqH".to_string(),
